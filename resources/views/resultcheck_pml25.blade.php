...
<script>
    ...
    const categoryBackgrounds = {
        '5KUMUM': '/img/result_pml25.webp',
        'default': '/img/result_pml25.webp' // fallback image
    };
...
<style>
    body {
        background-image: url('/img/result_pml25.webp');
        /* Default background */
...
<div class="d-flex justify-content-center align-items-center" style="height: 100vh; flex-direction: column;">
    ...
    <div class="bibTag text-center">
        <div class='mt-2'>
            ...
            <h2 class="text-uppercase mt-3 mb-3 px-5" style="background-color: #23A142; color: #FFFFFF ; padding-top: 10px; padding-bottom: 10px;">I'M FINISHER</h2>
