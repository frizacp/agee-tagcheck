...
<script>
    ...
    const categoryBackgrounds = {
        '5KUMUM': '/img/full_Jeparundise.webp',
        'default': '/img/full_Jeparundise.webp' // fallback image
    };
...
<style>
    body {
        background-image: url('/img/full_Jeparundise.webp');
        /* Default background */
...
<div class="d-flex justify-content-center align-items-center" style="height: 100vh; flex-direction: column;">
    ...
    <div class="bibTag text-center mt-5">
        <div class='mt-5'>
            <h2 class="text-uppercase mt-4" id="resultName" style="color: #2A5969">NAMA</h2>
            <h5 class="text-uppercase" id="category" style="color: #2A5969">KATEGORI</h5>
            <h2 class="text-uppercase" id="resultBib" style="color: #2A5969">BIB</h2>
        </div>
    </div>
</div>
@endsection