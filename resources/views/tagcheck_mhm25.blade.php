...
<script>
    ...
    const categoryBackgrounds = {
        '5KUMUM': '/img/5k.webp',
        '10KUMUM': '/img/10k.webp',
        '21KUMUM': '/img/21k_umum.webp',
        '21KMASTER': '/img/21k_master.webp',
        'default': '/img/10k.webp' // fallback image
    };
...
<style>
    body {
        background-image: url('/img/10k.webp');
        /* Default background */
...
<div class="d-flex justify-content-center align-items-start"
    style="height: 100vh; flex-direction: column; padding-left: 80px;">
